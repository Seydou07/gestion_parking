/*
  ...
  - You are about to drop the column `plafond` on the `fuel_cards` table. All the data in the column will be lost.
...
-- AlterTable
ALTER TABLE `fuel_cards` DROP COLUMN `plafond`,
    ADD COLUMN `litresEstimes` DOUBLE NULL,
    ADD COLUMN `prixLitre` DOUBLE NULL;

-- AlterTable
ALTER TABLE `fuel_records` ADD COLUMN `prixLitre` DOUBLE NULL;
