...
-- AlterTable
ALTER TABLE `missions` ADD COLUMN `bonCarburantId` INTEGER NULL,
    ADD COLUMN `carteCarburantId` INTEGER NULL,
    ADD COLUMN `montantCarburantUtilise` DOUBLE NULL,
    ADD COLUMN `observationDepart` TEXT NULL,
    ADD COLUMN `observationRetour` TEXT NULL,
    ADD COLUMN `ticketCarburantUrl` VARCHAR(191) NULL,
    ADD COLUMN `typeCarburantDotation` VARCHAR(191) NULL,
    MODIFY `kmDepart` INTEGER NOT NULL DEFAULT 0;
