        ...
        <aside className={cn(
            ...
            <div className={cn(
                ...
                {isOpen && (
                    <div className="flex flex-col overflow-hidden">
                        <span className="text-lg font-black text-fleet-blue tracking-tight leading-tight">FleetGuardian</span>
                    ...
                    return (
                        <Link
                            ...
                            className={cn(
                                ...
                                isActive 
                                    ? "bg-fleet-blue/[0.04] text-fleet-blue border-r-4 border-fleet-blue" 
                                    : "text-slate-500/60 hover:bg-slate-50 hover:text-fleet-blue border-r-4 border-transparent",
            ...
            <div className="p-4 border-t border-slate-200 dark:border-slate-800 flex-shrink-0">
                <Link
                    href="/login"
                    className={cn(
                        "flex items-center gap-3 rounded-xl hover:bg-rose-50 text-rose-600 transition-all font-bold",
                ...
                >
                    ...
                    {isOpen && <span className="text-[9px] font-black uppercase tracking-[0.2em] bg-rose-50 px-3 py-1.5 rounded-lg border border-rose-100">Déconnexion</span>}
                </Link>
            </div>
        </aside>
    );
