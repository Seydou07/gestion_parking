...
-- AlterTable
ALTER TABLE `history_logs` ADD COLUMN `entiteId` INTEGER NULL,
    ADD COLUMN `entiteType` VARCHAR(191) NULL;

-- AlterTable
ALTER TABLE `maintenances` ADD COLUMN `mainDoeuvre` DOUBLE NULL DEFAULT 0;
